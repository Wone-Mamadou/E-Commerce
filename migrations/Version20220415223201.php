 ...
 */
final class Version20220415223201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE toto (id INT AUTO_INCREMENT NOT NULL, tata VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, id_personne INT NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX id_personne (id_personne), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, prenom VARCHAR(20) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, login VARCHAR(20) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, mdp VARCHAR(20) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, dateInscription DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT commande_ibfk_1 FOREIGN KEY (id_personne) REFERENCES personne (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
